...
//
template <>
__device__ inline void dequant<half2, sglang::kU4B8.id(), true>(int q,
                                                              half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kU4B8.id(), false>(int q,
                                                               half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kU4.id(), true>(int q,
                                                            half2* frag_b) {
  dequant<half2, sglang::kU4B8.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, sglang::kU4.id(), false>(int q,
                                                             half2* frag_b) {
  const int LO = 0x000f000f;
  const int HI = 0x00f000f0;
  const int EX = 0x64006400;
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU4B8.id(), true>(
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU4B8.id(), false>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU4.id(), true>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, sglang::kU4B8.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU4.id(), false>(
    int q, nv_bfloat162* frag_b) {
...
//
template <>
__device__ inline void dequant<half2, sglang::kU8B128.id(), true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kU8B128.id(), false>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kU8.id(), true>(int q,
                                                            half2* frag_b) {
  dequant<half2, sglang::kU8B128.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, sglang::kU8.id(), false>(int q,
                                                             half2* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU8B128.id(), false>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kU8.id(), false>(
    int q, nv_bfloat162* frag_b) {
  float fp32_intermediates[4];
  uint32_t* fp32_intermediates_casted =
      reinterpret_cast<uint32_t*>(fp32_intermediates);
...
template <>
__device__ inline void dequant<half2, sglang::kFE4M3fn.id(), true>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kFE4M3fn.id(), false>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kFE4M3fn.id(), true>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kFE4M3fn.id(), false>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kFE2M1f.id(), true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, sglang::kFE2M1f.id(), false>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kFE2M1f.id(), true>(
    int q, nv_bfloat162* frag_b) {
  // Constants for FP4 (E2M1) and FP16 formats
...
template <>
__device__ inline void dequant<nv_bfloat162, sglang::kFE2M1f.id(), false>(
    int q, nv_bfloat162* frag_b) {
