...
MarlinFuncPtr get_marlin_kernel(const sglang::ScalarType q_type,
...
template <typename scalar_t>
exec_config_t determine_exec_config(const sglang::ScalarType& q_type, int prob_m,
...
void marlin_mm(const void* A, const void* B, void* C, void* C_tmp, void* s,
               ...
               sglang::ScalarType const& q_type, bool has_act_order,
  ...
  if (has_zp) {
    ...
    TORCH_CHECK(
        q_type == sglang::kU4B8 || q_type == sglang::kU8B128 ||
            q_type == sglang::kFE4M3fn || q_type == sglang::kFE2M1f,
...
torch::Tensor gptq_marlin_gemm(
  ...
  if (global_scale_or_none.has_value()) {
    ...
    TORCH_CHECK(b_q_type == sglang::kFE2M1f,
  ...
  if (has_zp) {
    ...
    TORCH_CHECK(b_q_type == sglang::kU4B8 || b_q_type == sglang::kU8B128 ||
